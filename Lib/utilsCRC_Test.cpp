...
void UnitTest_CRC()
{
	...
	// test constexpr
	//std::uint8_t* TblPtr = (std::uint8_t*)&crc::table::CRC08_DALLAS_Table;
	//*TblPtr = 8; // error - it's unchangeable
	...
	//CRC08_BNTBX1
	{
		const std::vector<char> Data{ 0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39 };
	...
	//CRC16_BNTBX2
	{
		std::vector<std::uint8_t> Data{ 0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39 };
